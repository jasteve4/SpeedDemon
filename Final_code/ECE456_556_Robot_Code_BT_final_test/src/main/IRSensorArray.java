...
public class IRSensorArray 
{
	...
	public double calculatePosition()
	{
		...
		if((readings[0]<MAX-66)&&(readings[2]>MAX-66))
		{
			statePosition = 1;
		}
		else if((readings[0]>MAX-66)&&(readings[2]<MAX-66))
		{
			statePosition = -1;
		}
		else if((readings[0]>MAX-66)&&(readings[2]>MAX-66))
		...
		return  setPoint + statePosition * (66 + leftPostion + rightPostion + 5*centerPostion);
